...
class StudentDetails {
    public static Stream<Student> getStudentsList(){
        Stream<Student> studentStream  = Stream.of(
                new Student(111, "Jiya Brein", 17, "Female", "Computer Science", 2018, 70.8),new Student(122, "Paul Niksui", 18, "Male", "Mechanical", 2016, 50.2),
